...
next_2 :: proc(g: ^Gen2($R1, $R2)) -> (R1, R2, bool) {
    Vals :: struct {
        val1: R1,
        val2: R2,
    }
...
next_3 :: proc(g: ^Gen3($R1, $R2, $R3)) -> (R1, R2, R3, bool) {
    Vals :: struct {
        val1: R1,
        val2: R2,
        val3: R3,
...
next_4 :: proc(g: ^Gen4($R1, $R2, $R3, $R4)) -> (R1, R2, R3, R4, bool) {
    Vals :: struct {
        val1: R1,
        val2: R2,
        val3: R3,
...
yield_2 :: proc(g: Gen2($R1, $R2), val1: R1, val2: R2) {
    Vals :: struct {
        val1: R1,
        val2: R2,
    }
